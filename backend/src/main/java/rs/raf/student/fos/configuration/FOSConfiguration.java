package rs.raf.student.fos.configuration;
...
public class FOSConfiguration {
    ...
    public static class Application {
        ...
        public static final String BEEN_NAME = FOSConfiguration.BEEN_NAME + SEPARATOR + "application";
    ...
    public static class Jwt {
        ...
        public static final String BEEN_NAME = FOSConfiguration.BEEN_NAME + SEPARATOR + "jwt";
    ...
    public static class Cors {
        ...
        public static final String BEEN_NAME = FOSConfiguration.BEEN_NAME + SEPARATOR + "cors";
    ...
    public static class Controller {
        ...
        public static final String BEEN_NAME = FOSConfiguration.BEEN_NAME + SEPARATOR + "controller";
    ...
    public static class Permission {
        ...
        public static final String BEEN_NAME = FOSConfiguration.BEEN_NAME + SEPARATOR + "permissions";
