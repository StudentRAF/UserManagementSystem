...
import rs.raf.student.fos.adapter.PermissionsAdapter;
import rs.raf.student.fos.configuration.FOSConfiguration;
...
public class Permissions {
    ...
    public static final Permissions NONE       = Permissions.of(FOSConfiguration.Permission.NONE, 0     );
    public static final Permissions CAN_READ   = Permissions.of(FOSConfiguration.Permission.CAN_READ, 1 << 0);
    public static final Permissions CAN_CREATE = Permissions.of(FOSConfiguration.Permission.CAN_CREATE, 1 << 1);
    public static final Permissions CAN_UPDATE = Permissions.of(FOSConfiguration.Permission.CAN_UPDATE, 1 << 2);
    public static final Permissions CAN_DELETE = Permissions.of(FOSConfiguration.Permission.CAN_DELETE, 1 << 3);
